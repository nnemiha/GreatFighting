...
{
    [CustomPropertyDrawer(typeof(SSRandomizeModifier))]
    public class SSRandomizeModifierDrawer : SSPropertyDrawer
    {
        ...
        protected override void DrawAllProperties(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            EditorGUI.LabelField(labelRect, "Randomize Modifier", SSGUIStyle.GetLabelGUIStyle());
            ...
            if (property.isExpanded)
            {
                ...
                DrawProperty(position, _rangeMin, "Range Min");
                
                DrawProperty(position, _rangeMax, "Range Max");
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            if (property.isExpanded)
            {
                ...
                height += EditorGUI.GetPropertyHeight(_rangeMin);
                height += EditorGUI.GetPropertyHeight(_rangeMax);
            }
        ...
        {
            _rangeMin = property.FindPropertyRelative("rangeMin");
            _rangeMax = property.FindPropertyRelative("rangeMax");
        }
    }
}