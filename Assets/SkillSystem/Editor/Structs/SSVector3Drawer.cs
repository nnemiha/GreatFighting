...
{
    [CustomPropertyDrawer(typeof(SSVector3))]
    public class SSVector3Drawer : SSPropertyDrawer
    {
        ...
        private enum ModifierType {AddModifier, SaveToDictionary, Move, Multiply, Normalize, Randomize, Rotate}
            ...
            if (_modifierType != ModifierType.AddModifier)
            {
                ...
                switch (_modifierType)
                {
                    ...
                    case ModifierType.Move:
                        newElement.managedReferenceValue = new SSMoveModifier();
                        break;
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            if (_variableType.intValue == (int)SSVariableType.ByValue) height += EditorGUI.GetPropertyHeight(_variableValue);
            else if (_variableType.intValue == (int)SSVariableType.ByReference) height += EditorGUI.GetPropertyHeight(_variableReference);
