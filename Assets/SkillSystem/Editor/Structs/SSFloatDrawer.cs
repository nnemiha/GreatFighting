...
{
    [CustomPropertyDrawer(typeof(SSFloat))]
    public class SSFloatDrawer : SSPropertyDrawer
    {
        ...
        private enum ModifierType {AddModifier, SaveToDictionary, Add, Multiply, Normalize, Randomize}
        ...
        protected override void DrawAllProperties(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            else if (_variableType.intValue == (int)SSVariableTypeWithValue.ByDictionaryKeyName)
            {
            ...
            if (_modifierType != ModifierType.AddModifier)
            {
                ...
                switch (_modifierType)
                {
                    ...
                    case ModifierType.Add:
                        newElement.managedReferenceValue = new SSAddModifier();
                        break;
                    case ModifierType.Multiply:
                        newElement.managedReferenceValue = new SSMultiplyModifier();
                        break;
